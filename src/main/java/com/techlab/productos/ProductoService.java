...
public class ProductoService {
    ...
    public void ingresarProducto() {
        ...
        precioProducto = ConsoleUtils.inputDouble("Ingrese precio: ");
        cantidadEnStock = ConsoleUtils.inputInteger("Ingrese cantidad en stock: ");

        // Se crea el producto validandolo primero
